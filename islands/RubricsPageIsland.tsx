...
export default function RubricsPageIsland({ user, rubrics, isTeacher }: RubricsPageIslandProps) {
  ...
  const loadCriteria = async (rubric: Rubric) => {
    ...
    try {
      const response = await fetch(`/api/rubric-criteria?rubricId=${rubric.id}`);
            ...
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
              ...
              <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                {rubricsList.map((rubric) => (
                  <tr key={rubric.id} class="hover:bg-gray-50 dark:hover:bg-gray-700">
                    <td class="px-6 py-4 whitespace-nowrap">
                      <div class="text-sm font-medium text-gray-900 dark:text-white">{rubric.name}</div>
                    </td>
                    <td class="px-6 py-4">
        ...
        <div class="space-y-6">
          ...
          <div class="bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden">
            {criteria.length > 0 ? (
                ...
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                  ...
                  <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                    {criteria.map((criterion) => (
                      <tr key={criterion.id} class="hover:bg-gray-50 dark:hover:bg-gray-700">
                        <td class="px-6 py-4 whitespace-nowrap">
              ...
              <div class="p-6 text-center">
                <p class="text-gray-500 dark:text-gray-400">
                  No hay criterios definidos para esta rúbrica. Añade criterios para comenzar.
                </p>
              </div>
            )}
          </div>
          ...
          <div class="border-t pt-4 dark:border-gray-700">
            <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-4">Añadir Nuevo Criterio</h3>
