...
import {
	createUser,
	getAllUsersWithTeamMemberships,
	deleteUser,
	deleteTeamMembersByUserId,
} from "../../utils/db.ts";
		...
		try {
			...
			if (error instanceof Error) {
				if (
					...
					errorMessage =
						"No se puede eliminar el usuario porque está asignado a uno o más proyectos. Elimine primero las asignaciones del usuario.";
				} else {
