...
export async function updateProject(
	id: number,
	projectData: Partial<
		Omit<typeof projects.$inferInsert, "id" | "createdAt" | "updatedAt">
	>,
) {
	return await db
		.update(projects)
...
export async function createTeam(
	teamData: Omit<typeof teams.$inferInsert, "id" | "createdAt" | "updatedAt">,
) {
...
export async function updateTeam(
	id: number,
	teamData: Partial<
		Omit<typeof teams.$inferInsert, "id" | "createdAt" | "updatedAt">
	>,
) {
	return await db
		.update(teams)
...
export async function createTeamMember(
	teamMemberData: Omit<
		typeof teamMembers.$inferInsert,
		"id" | "createdAt" | "updatedAt"
	>,
) {
...
export async function updateTeamMember(
	id: number,
	teamMemberData: Partial<
		Omit<typeof teamMembers.$inferInsert, "id" | "createdAt" | "updatedAt">
	>,
) {
	return await db
		.update(teamMembers)
...
export async function createTask(
	taskData: Omit<typeof tasks.$inferInsert, "id" | "createdAt" | "updatedAt">,
) {
...
export async function updateTask(
	id: number,
	taskData: Partial<
		Omit<typeof tasks.$inferInsert, "id" | "createdAt" | "updatedAt">
	>,
) {
	return await db
		.update(tasks)
...
export async function updateSprint(
	id: number,
	sprintData: Partial<
		Omit<typeof sprints.$inferInsert, "id" | "createdAt" | "updatedAt">
	>,
) {
	return await db
		.update(sprints)
...
export async function createUserStory(
	userStoryData: Omit<
		typeof userStories.$inferInsert,
		"id" | "createdAt" | "updatedAt"
	>,
) {
...
export async function updateUserStory(
	id: number,
	userStoryData: Partial<
		Omit<typeof userStories.$inferInsert, "id" | "createdAt" | "updatedAt">
	>,
) {
	return await db
		.update(userStories)
...
export async function getRubricsByCreatorId(creatorId: number) {
	return await db
		.select()
		.from(rubrics)
		.where(eq(rubrics.creatorId, creatorId));
}
...
export async function updateRubric(
	id: number,
	rubricData: Partial<
		Omit<typeof rubrics.$inferInsert, "id" | "createdAt" | "updatedAt">
	>,
) {
	return await db
		.update(rubrics)
...
export async function createRubricCriterion(
	criterionData: Omit<
		typeof rubricCriteria.$inferInsert,
		"id" | "createdAt" | "updatedAt"
	>,
) {
...
export async function updateRubricCriterion(
	...
	criterionData: Partial<
		Omit<typeof rubricCriteria.$inferInsert, "id" | "createdAt" | "updatedAt">
	>,
) {
	return await db
